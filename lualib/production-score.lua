...
local function get_raw_resources()
  ...
  for _, entity_prototype in pairs (entities) do
...
local deduce_nil_prices = function(price_list, param)
  ...
  for name, nil_price_recipes in pairs (nil_prices) do
    if #nil_price_recipes > 0 then
      local recipe_cost
      local ingredient_amount
      for _, recipe in pairs (nil_price_recipes) do
